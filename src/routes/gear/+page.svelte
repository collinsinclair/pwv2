...
<svelte:head>
	<title>Gear - Collin Sinclair</title>
	<meta
		name="description"
		content="This is a treemap of Gabby's and my camping/hiking/climbing/ski gear. Used for my own organizational purposes."
	/>
</svelte:head>

<main class="container">
	<h1 class="text-zinc-200 text-3xl py-3">Gear</h1>
	<p class="text-zinc-200 text-justify pb-2">
		This is a treemap of Gabby's and my camping/hiking/climbing/ski gear. Used for my own
		organizational purposes.
	</p>
	<div id="chartdiv" style="width: 1000px; height: 1000px;" class="mx-auto" />
</main>
